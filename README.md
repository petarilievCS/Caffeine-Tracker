...
iOS application that lets the user track their daily caffeine intake, helps the user regulate the amount of caffeine in their bloodstream and locates nearby coffee shops for the user. The user can add their favorite drinks to the app and log them every day. The app displays the total caffeine intake for the day, as well as the current amount in the bloodstream. The app is developed in Swift, and uses CoreData to store the data. 
